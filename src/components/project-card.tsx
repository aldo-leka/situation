...
export function ProjectCard({ project, loading }: ProjectCardProps) {
  ...
  return (
    <Card className="border-0 aspect-square py-2 gap-2 hover:ring-zinc-700 transition-shadow">
      ...
      <CardContent className="px-2.5 space-y-2 flex-1 overflow-y-auto min-h-0">
        {/* GitHub section */}
        {project.github && (
          <div>
            ...
            {project.github.error ? (
              <p className="text-xs text-destructive">{project.github.error}</p>
        ...
        {project.trello && (
          <div>
            ...
            {project.trello.error ? (
              <p className="text-xs text-destructive">{project.trello.error}</p>
        ...
        {!project.trello && project.github && project.type !== "daily-habit" && (
          <div className="flex items-center gap-1 text-[10px] text-muted-foreground">
            ...
            <span className="italic">No Trello board</span>
          </div>
        )}
      </CardContent>
    </Card>
